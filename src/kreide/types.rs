...
#[il2cpp_ref_type(
    ...
    base(RPG_GameCore_GameComponentBase)
)]
...
impl RPG_GameCore_AvatarPropertyExcelTable {
    ...
    pub fn GetData(
        property_type: RPG_GameCore_AvatarPropertyType,
    ) -> RPG_GameCore_AvatarPropertyRow {
    }
}
...
impl RPG_Client_CachedAssetLoader {
    ...
    pub fn SyncLoadAsset(
        asset_name: Il2CppString,
        ty: System_Type,
        flag: bool,
    ) -> UnityEngine_Object {
    }
